...
function _n(tag){$gwxc++;if($gwxc>=16000){throw 'Dom limit exceeded, please check if there\\'s any mistake you\\'ve made.'};return {tag:tag.substr(0,3)=='zf-'?tag:'zf-'+tag,attr:{},children:[],n:[]}}
...
return function(env,dd,global){$gwxc=0;var root={"tag":"zf-page"};root.children=[]
var main=e_[path].f
